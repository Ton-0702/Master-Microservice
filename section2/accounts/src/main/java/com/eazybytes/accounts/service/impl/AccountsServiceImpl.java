...
public class AccountsServiceImpl implements IAccountsService {
    ...
    public void createAccounts(CustomerDto customerDto) {
        ...
        // after save I need to get Id from customer so that I need store save method into variable
    ...
    public boolean updateAccount(CustomerDto customerDto) {
        ...
        if(accountsDto != null) {
            ...
            AccountsMapper.mapToAccounts(accountsDto, accounts); // set new values from parameter to copy to accounts current to update
