...
@ConfigurationProperties(prefix = "cards") // reference at application.yml define properties, and to use this annotation use need to @EnableConfigurationProperties at Springboot application
